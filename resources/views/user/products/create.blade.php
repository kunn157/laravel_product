...
<div class="card card-primary-form">
    <div class="card-header">
      <h3 class="card-title">{{__("messages.create Product")}}</h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->
    <form method="post" action="{{route('products.store')}}" enctype="multipart/form-data" >
      ...
      <div class="card-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control input_name @error('name') is-invalid @enderror" value="{{old('name')}}" id="exampleInputEmail1" name="name" placeholder="Tên Sản Phẩm">
          @error('name')
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control input_stock @error('stock') is-invalid @enderror"value="{{old('stock')}}" id="exampleInputPassword1" name="stock" placeholder="">
          @error('stock')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="form-group">
            ...
            <input type="date" name="expired_at" value="{{old('expired_at')}}" class="form-control input_expired @error('expired_at') is-invalid @enderror" >
            @error('expired_at')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
          ...
          <div class="form-group">
              ...
              <img id="ImdID" class ="avatar" src="{{asset('assets/img/no-img.png')}}" alt="Image"  />
              @error('avatar')
              <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="form-group">
              <div class="form-group">
                ...
                <input type="text" class="form-control input_sku @error('sku') is-invalid @enderror" value="{{old('sku')}}" name="sku" id="exampleInputPassword1" placeholder="">
                @error('sku')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="form-group">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control input_sku @error('sku') is-invalid @enderror" value="{{old('price')}}" name="price" id="exampleInputPassword1" placeholder="">
                  @error('sku')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                  </span>
            ...
            <div>
                <div class="productview" id="productview">
                 ...
                 <img src="{{asset('assets/img/no-img.png')}}" class="show_img" alt="">
                </div>
            </div>
    </form>
  </div>
